...
<h1 align="center">dragonblocksuper</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `DragonBlockSuper-win-x64.exe ` |
| macOS | `DragonBlockSuper-mac-universal.dmg` |
| Linux x64 | `DragonBlockSuper-linux-x86_64.AppImage` |
